...
SELECT c.id, x.name, x.price, x.stock_quantity, x.unit, TRUE, x.is_inventory_tracked, x.sort_order
FROM (
  VALUES
    ('ÕLU', 'Premium', 1.40, 0, 'tk', TRUE, 1),
    ('ÕLU', 'Premium Purk 0.33L', 1.00, 0, 'tk', TRUE, 2),
    ('ÕLU', 'Pilsner', 1.20, 0, 'tk', TRUE, 3),
    ('ÕLU', 'Warsteiner', 1.80, 0, 'tk', TRUE, 4),
    ('SÖÖK JA NÄKS', 'Tupla', 1.30, 0, 'tk', TRUE, 1),
